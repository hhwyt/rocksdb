...
void Version::AddIterators(const ReadOptions& read_options,
  ...
  ROCKS_LOG_DEBUG(vset_->db_options_->info_log, "AddIterators");

  ROCKS_LOG_DEBUG(vset_->db_options_->info_log,
                 "filter_max: %d, num_non_empty_levels: %d",
                 read_options.filter_lmax, storage_info_.num_non_empty_levels());
  int max_level = read_options.filter_lmax
                       ? storage_info_.num_non_empty_levels() - 1
                       : storage_info_.num_non_empty_levels();
  ROCKS_LOG_DEBUG(vset_->db_options_->info_log, "max_level: %d", max_level);
